...
"$data.Byte":$data.Container.proxyConverter,"$data.SByte":$data.Container.proxyConverter,"$data.Decimal":$data.Container.proxyConverter,"$data.Float":$data.Container.proxyConverter,"$data.Int16":$data.Container.proxyConverter,"$data.Int64":$data.Container.proxyConverter,"$data.ObjectID":$data.Container.proxyConverter,"$data.Integer":$data.Container.proxyConverter,"$data.Number":$data.Container.proxyConverter,"$data.Date":function(a){return a?a.toISOString().replace("Z",""):a},"$data.Time":function(a){return a?
a.toISOString().split("T")[1].replace("Z",""):a},"$data.DateTimeOffset":function(a){return a?a.toISOString():a},"$data.String":$data.Container.proxyConverter,"$data.Boolean":$data.Container.proxyConverter,"$data.Blob":function(a){return a?$data.Blob.toBase64(a):a},"$data.Object":$data.Container.proxyConverter,"$data.Array":$data.Container.proxyConverter,"$data.GeographyPoint":$data.Container.proxyConverter,"$data.Guid":$data.Container.proxyConverter},escape:{"$data.Entity":function(a){return JSON.stringify(a)},
"$data.Integer":$data.Container.proxyConverter,"$data.Number":$data.Container.proxyConverter,"$data.Int16":$data.Container.proxyConverter,"$data.Byte":$data.Container.proxyConverter,"$data.SByte":$data.Container.proxyConverter,"$data.Decimal":function(a){return a?a+"m":a},"$data.Float":function(a){return a?a+"f":a},"$data.Int64":function(a){return a?a+"L":a},"$data.Time":function(a){return a?"time'"+a+"'":a},"$data.DateTimeOffset":function(a){return a?"datetimeoffset'"+a+"'":a},"$data.Date":function(a){return a?
"datetime'"+a+"'":a},"$data.String":function(a){return"string"===typeof a?"'"+a.replace(/'/g,"''")+"'":a},"$data.ObjectID":function(a){return"string"===typeof a?"'"+a.replace(/'/g,"''")+"'":a},"$data.Boolean":function(a){return"boolean"===typeof a?a.toString():a},"$data.Blob":function(a){return a?"X'"+$data.Blob.toHexString($data.Container.convertTo(atob(a),$data.Blob))+"'":a},"$data.Object":function(a){return JSON.stringify(a)},"$data.Array":function(a){return JSON.stringify(a)},"$data.GeographyPoint":function(a){return a?
$data.GeographyBase.stringifyToUrl(a):a},"$data.Guid":function(a){return a?"guid'"+a.toString()+"'":a}}};
